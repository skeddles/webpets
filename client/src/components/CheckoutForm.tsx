	...
	return (<div className="CheckoutForm">
		...
		<form id="payment-form" onSubmit={handleSubmit}>
			...
			<div className="complete-payment">
				<div className="total">
					<h6>Total Amount:</h6>
					<div className="amount">{checkout.total.total.amount}</div>
				</div>
				<LoadingButton
					text={`Submit Payment`}
					loading={isLoading}
			...
			<p className="info">
				Your payment will be processed securely by Stripe. Your billing information and billing information will be used only for payment processing by Stripe and will not be stored by Pixel School or associated with your Pixel School account.
			</p>
